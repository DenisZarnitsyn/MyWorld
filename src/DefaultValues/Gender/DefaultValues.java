...
public class DefaultValues {
    ...
    // All
    public static int allXpAnimal = 2;

    // Grass
    public static double grassWeight = 1.0;
    public static int grassMaximumPerCell = 200;

    // Rabbit
    public static double rabbitWeight = 2.0;
    public static int rabbitMaxAnimalsPerCell = 150;
    public static int rabbitMaxMovement = 2;
    public static double rabbitSatiety = 0.45;

    // Horse
    public static double horseWeight = 400.0;
    public static int horseMaxAnimalsPerCell = 20;
    public static int horseMaxMovement = 4;
    public static double horseSatiety = 60;

    // Deer
    public static double deerWeight = 300.0;
    public static int deerMaxAnimalsPerCell = 20;
    public static int deerMaxMovement = 4;
    public static double deerSatiety = 50;

    // Goat
    public static double goatWeight = 60.0;
    public static int goatMaxAnimalsPerCell = 140;
    public static int goatMaxMovement = 3;
    public static double goatSatiety = 10;

    // Sheep
    public static double sheepWeight = 70.0;
    public static int sheepMaxAnimalsPerCell = 140;
    public static int sheepMaxMovement = 3;
    public static double sheepSatiety = 15;

    // Buffalo
    public static double buffaloWeight = 700.0;
    public static int buffaloMaxAnimalsPerCell = 10;
    public static int buffaloMaxMovement = 3;
    public static double buffaloSatiety = 100;
